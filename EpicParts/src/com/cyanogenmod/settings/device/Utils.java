...
public class Utils {
    private static final String TAG = "EpicParts_Utils";
    private static final String TAG_READ = "EpicParts_Utils_Read";
    private static final String TAG_WRITE = "EpicParts_Utils_Write";
